...
- 支持大图标 / 小图标切换；小图标模式使用紧凑卡片，仅显示图标和网页名称，隐藏网址。
...
在「我的网页」右侧工具栏点击「小图标」，星标区和所有标签下的卡片会一起缩小，只显示图标和网页名称，名称悬停提示也不显示网址。点击「大图标」可恢复原来的显示方式。选择自动保存在当前浏览器，刷新或重新进入后仍然生效；搜索、标签折叠以及整理网页均可在两种模式中使用。
